...
export default function Content_2Frahari() {
  return (
    <div className="text-white relative ">
      ...
      <p className="text-xl sm:text-8xl sm:mt-32 mt-16 sm:mb-16 mb-18">BEEN IN THE INDUSTRY<span className="text-[#EE8300]"> <br/>  
       </span><span className="text-[#EE8300]">FOR YEARS.</span></p>
     ...
     <Image src={Background_2} className="top-0 sh-full  sm:w-screen sm:h-screen sm:bg-cover"/>
     </div>
    </div>
  );
}
