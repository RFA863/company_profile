...
export default function Content() {
  return (
    <div className="text-white relative">
      ...
      <p className="text-xl sm:text-8xl sm:mt-32 mt-16 sm:mb-16 mb-18">YOUR <span className="text-[#EE8300]">GREAT PRODUCT <br/>  
       </span> DESERVED <span className="text-[#EE8300]">GOOD PACKAGING.</span></p>
     ...
     <Image src={Background_1} className=" top-0 sh-full  sm:w-screen sm:h-screen sm:bg-cover"/>
     </div>
    </div>
  );
}
